      ...
      "/checkout_sessions",
      {
        data: {
          attributes: {
            ...
            success_url: `${env.FRONTEND_URL}/bookings/confirmation?openPlayBookingId=${booking.id}&status=success`,
            cancel_url: `${env.FRONTEND_URL}/bookings/confirmation?openPlayBookingId=${booking.id}&status=cancelled`,
            send_email_receipt: false,
            show_line_items: true,
